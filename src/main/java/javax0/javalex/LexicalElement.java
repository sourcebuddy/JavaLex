...
/**
 * One lexical element after the lexical analysis.
 */
public interface LexicalElement {
    ...
    /**
     * Replace the existing original with a new original string.
     * <p>
     * The original contains the original text of a string or character literal as it is in the source code without
     ...
     * contains these in their original sequence.
     * <p>
     * When the original is set then this setter calculates the escaped string converting all escape sequences
     * replacing them with the character they mean and it is stored in the field {@code lexeme}. That way there is no
     * need to call {@link #setLexeme(String)} after calling this method.
     * <p>
     * This method should be called only in case the lexical element is a CHARACTER or STRING. Calling this method on
     * any other type of lexical element will throw a {@link RuntimeException}.
     *
