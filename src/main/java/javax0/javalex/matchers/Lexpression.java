...
import javax0.javalex.LexpressionBuilder.GroupNameWrapper;
...
public class Lexpression {
    ...
    private final Map<String, List<javax0.javalex.LexicalElement>> groups = new HashMap<>();
     ...
     */
    void store(String name, List<javax0.javalex.LexicalElement> elements) {
