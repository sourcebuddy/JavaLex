 ...
 */
public class JavaSourceDiff implements BiPredicate<String, String> {
     ...
     * @return {@code this}
     */
    public JavaSourceDiff commentSensitive() {
        checkComments = true;
        return this;
    }
     ...
     */
    @Override
    public boolean test(String strings1, String strings2) {
